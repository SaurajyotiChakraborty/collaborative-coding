...
const WaitingLobby = ({ competition, onExit }: { competition: any, onExit: () => void }) => (
...
const InProgressArena = ({ competition }: { competition: any }) => (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 p-4 md:p-8">
...
const CompletedArena = ({ onBack }: { onBack: () => void }) => (
    <div className="min-h-screen flex items-center justify-center p-8">
        <Card className="max-w-2xl w-full p-8 text-center space-y-6">
            ...
            <Button onClick={onBack} className="w-full bg-gradient-to-r from-purple-600 to-pink-600">
                Back to Dashboard
            </Button>
        </Card>
    </div>
...
export default function CompetitionArenaPage() {
    ...
    // Simplified rendering with sub-components for hook stability
    const renderContent = () => {
        ...
        if (!competition) {
            return (
                <div className="min-h-screen flex items-center justify-center">
                    <p className="text-muted-foreground">Competition not found or access denied.</p>
                </div>
            );
        }
        ...
        switch (competition.status) {
            ...
            default:
                return (
                    <div className="min-h-screen flex items-center justify-center">
                        <p className="text-muted-foreground">Unknown competition status.</p>
                    </div>
                );
        }
    };
